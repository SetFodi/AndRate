              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    disabled={page === 1}
                    className="flex items-center gap-1 px-3 py-2 rounded-lg bg-zinc-800 border border-white/10 hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-2 rounded-lg bg-zinc-800 border border-white/10 hover:bg-zinc-700 transition-colors"
                  >
                    Next
